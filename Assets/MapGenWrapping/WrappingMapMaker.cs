...
public class WrappingMapMaker : MonoBehaviour
{
    ...
    WrappingCameraControl _cameraControl;
    ...
    private void Generate()
    {
        ...
        transform.position = new Vector3(GetComponent<WrappingMapMaker>().mapSize.x / 2 * HorizontalOffsetFactor, GetComponent<WrappingMapMaker>().mapSize.y / 2 * VerticalOffsetFactor, -10);
    ...
    void Start()
    {
        ...
        _cameraControl = GetComponent<WrappingCameraControl>();
        Generate();
